...
export function SenderInfo() {
    const { sender, setSender, touchField, touchedFields, language } = useInvoiceStore();
    const t = getTranslations(language);

    const handleChange = (field: keyof typeof sender) => (
        ...
        <div className="section-card animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        className={`input-field min-h-[80px] ${isError('address') ? 'error' : ''}`}
                ...
                <div>
                    <label className="input-label">
                        {t.phone}
                        <span className="text-xs text-zinc-500 ml-2">({t.phoneNumericOnly})</span>
                    </label>
                    <input
                        type="tel"
                        inputMode="numeric"
